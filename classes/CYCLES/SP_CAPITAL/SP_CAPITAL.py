...
class ResponsesSPCAPITAL(SPCAPITAL):
    ...
    COLETA_SEPARACAO = "As lâmpadas ao serem recolhidas são encaminhadas para base EQS onde ficam temporariamente armazenadas aguardando quantidade suficiente para coleta e destinação final."
    TRANSPORTADOR = "Tramppo"
    DESTINADOR = "Tramppo"
    QUANTIDADE_ANUAL = 40
    FREQUENCIA = "Sob demanda"
    AREA_RESPONSAVEL = "Patrimônio"
